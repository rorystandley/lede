...
export function DigestPage({ onClose, onOpenArticle }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-end md:items-center justify-center z-50">
      <div className="bg-surface rounded-t-xl md:rounded-lg border border-border shadow-xl w-full md:max-w-3xl md:mx-4 max-h-[92vh] md:max-h-[85vh] overflow-y-auto">
