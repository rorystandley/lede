...
> In journalism, the *lede* is the opening of a story — the line that tells you what matters and why to keep reading. Spelled the old newsroom way to keep it apart from the "lead" they once set type with. That's the whole idea here: surface what's worth your attention, skip the rest.
